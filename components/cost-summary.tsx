...
export function CostSummary({
  ...
  const totalWithProfit = totalCost + totalCost * 0.4;
  ...
  return (
    <div className="space-y-3 p-4 rounded-lg bg-gradient-to-br from-primary/10 to-primary/5 border border-primary/20">
      ...
      <div className="border-t border-primary/20 pt-3">
        ...
        <div className="flex justify-between mb-3">
          <span className="font-semibold text-green-700 dark:text-green-400">Con ganancia (+40%)</span>
          <span className="font-bold text-lg text-green-700 dark:text-green-400">{formatCurrency(totalWithProfit)}</span>
        </div>
