    ...
    <nav className="sticky top-0 w-full z-50 bg-surface/80 dark:bg-surface/80 backdrop-blur-xl shadow-sm border-b border-surface-container-low dark:border-surface-dim">
      <div className="flex justify-between items-center px-6 lg:px-8 py-4 max-w-7xl mx-auto">
        ...
        <div className="hidden md:flex items-center gap-4">
          <Link href="/login" className="font-headline text-body-md text-on-surface font-medium hover:text-primary transition-colors">
            Iniciar sesión
          </Link>
          <Link href="/login" className="gradient-bg text-on-primary font-headline text-sm font-semibold py-3 px-6 rounded-xl hover:opacity-90 active:scale-95 transition-all duration-200 shadow-md">
            Empezar gratis
          </Link>
        </div>
